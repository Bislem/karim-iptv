    ...
    <div class="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-24 lg:px-6">
        <figure class="max-w-screen-md mx-auto">
            <h2 class="text-white text-3xl font-semibold text-start md:text-center">What's the most thing that interests you? <br> <span
                    class="dark:text-green-400">Search it up !</span>
            </h2>
            <p class="text-white my-4 text-start md:text-center">Tell us what you're searching for in this input right here !</p>
            <div class="mt-10">
                <form>
